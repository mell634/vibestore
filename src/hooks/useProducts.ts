...
function mapProduct(raw: any): Product {
  return {
    ...
    category: raw.categories ? { 
      ...
      gender: raw.categories.gender, 
      type: raw.categories.type 
    } : undefined,
    ...
    images: (raw.product_images ?? []).sort((a: any, b: any) => a.display_order - b.display_order),
    variants: (raw.product_variants ?? []).sort((a: any, b: any) => a.display_order - b.display_order),
